...
public:
    ...
    cci::cci_param<bool> p_zicsr;
    cci::cci_param<bool> p_zifencei;
    ...
    QemuCpuRiscv32(const sc_core::sc_module_name& name, QemuInstance& inst, const char* model, uint64_t hartid)
        ...
        , p_zicsr("zicsr", true, "Enable Zicsr extension (CSR access)")
        , p_zifencei("zifencei", true, "Enable Zifencei extension (instruction fence)")
    ...
    void before_end_of_elaboration()
    {
        ...
        // Extensions
        cpu.set_prop_bool("zicsr", p_zicsr);
        cpu.set_prop_bool("zifencei", p_zifencei);
